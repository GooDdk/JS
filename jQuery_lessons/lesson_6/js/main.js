...
/* Фильтры форм в Query */
 ...
 // $('input:checkbox').css('dispaly' , 'block'); // Чекбоксы 
 ...
 // $('input:sumbit').css('border', '1px solid red'); // Кнопка "Отправить"
 // $('input:reset').css('border', '1px solid red'); // Кнопка "Сбросить"
 // $('input:image').css('border', '1px solid red'); // Кнопка-картинка
 // $('input:focus').css('dispaly', 'block'); // Выбранное поле (состояние фокус)
 // $('input:checkred').css('border', '1px solid red'); // Выбранный чекбокс или радио-кнопка
